...
<body class="auth-body">
    ...
    <div class="auth-shell">
        <div class="auth-side">
            ...
            <p>Manage students, courses, and records in one place. Sign in to access your dashboard.</p>
            <ul class="feature-list">
                <li>&#10003; Admin manages students</li>
                <li>&#10003; Teachers manage courses and grades</li>
